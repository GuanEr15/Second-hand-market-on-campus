...
<div class="top clearfix" id ="user-top">
    ...
    <div id="user_photo">
          	<#if guaner_student.headPic??>
          	<img id="origin_ph" onClick="openUploadPanel()" src="/photo/view?filename=${guaner_student.headPic}" old-src="/photo/view?filename=${guaner_student.headPic}" alt="大头像">
			<#else>
        ...
        <div id="my_info">
            <div id="account_info">
				...
				<ul class="infos" id="userid">
					<li>账号ID</li><li class="right_info">${guaner_student.id}</li>
				</ul>
			    <ul class="infos" id="userstate">
				    <li>账号状态</li>
				    <li class="right_info"><#if guaner_student.status == 1>正常<#else>冻结</#if></li>
				</ul>
			</div>
            <div id="account_info">
                <ul class="infos">
                    <li>学号</li>
                    <li class="right_info">${guaner_student.sn}</li>
                </ul>
            </div>
            <div id="base_info">
            ...
            <div id="base_info">
                ...
                <ul class="infos">
                    <li>昵称</li>
                    <li class="right_info">
                        <span class="baseinfo" id="nickname_span">${guaner_student.nickname!""}</span>
                        <input class="baseinfo" value="${guaner_student.nickname!""}" id="nickname" type="text">
                    </li> 
                </ul>
                <ul class="infos">
                    <li>手机</li>
                    <li class="right_info">
                        <span class="baseinfo" id="phone_span">${guaner_student.mobile!""}</span>
                        <input class="baseinfo" value="${guaner_student.mobile!""}" id="mobile" type="text">
                    </li>
                </ul>
                <ul class="infos">
                    <li>QQ</li>
                    <li class="right_info">
                        <span class="baseinfo" id="qq_span">${guaner_student.qq!""}</span>
                        <input class="baseinfo" value="${guaner_student.qq!""}" id="qq" type="text">
                    </li>
                </ul>
                <ul class="infos">
                    <li>学院</li>
                    <li class="right_info">
                        <span class="baseinfo" id="college_span">${guaner_student.academy!""}</span>
                        <input class="baseinfo" value="${guaner_student.academy!""}" id="academy" type="text">
                    </li>
                </ul>
                <ul class="infos">
                    <li>年级</li>
                    <li class="right_info">
                        <span class="baseinfo" id="grade_span">${guaner_student.grade!""}</span>
                        <input class="baseinfo" value="${guaner_student.grade!""}" id="grade" type="text">
                    </li>
                </ul>
                <ul class="infos">
                    <li>学校</li>
                    <li class="right_info">
                        <span class="baseinfo" id="area_span">${guaner_student.school!""}</span>
                        <input class="baseinfo" value="${guaner_student.school!""}" id="school" type="text">
                    </li>
                </ul>
            </div>
        </div>
