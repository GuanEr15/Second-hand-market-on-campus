...
<head>
    ...
    <link href="/home/css/bootstrap.min.css" type="text/css">
</head>
<body>
            ...
            <div class="form-wr">
                <div class="form-must-wr">
                    ...
                    <div class="form-item l goods-price">
                        ...
                        <div class="form-value">
                            <div class="form-input-wr">
                                <input class="price required" id="buyPrice" name="buyPrice" value="" type=""
                                       tips="请填写购物价格"></div>
                        </div>
                    </div>
                    <div class="form-item l goods-price">
                        ...
                        <div class="form-value">
                            <div class="form-input-wr">
                                <input class="price required" id="sellPrice" name="sellPrice" value="" type=""
                                       tips="请填写出售价格"></div>
                        </div>
                    </div>
                    ...
                    <div class="form-item l goods-cat">
                        ...
                        <div class="form-value">
                            <div class="form-input-wr">
                                ...
                                <select class="form-control" id="cid2" name="goodsCategory.id"
                                        style="border: none;
                                        outline: none;
                                        width: 40%;
                                        height: 30px;
