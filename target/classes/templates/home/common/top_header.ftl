        ...
        <div class="ease2 log-reg" id="have-not-login">
            <#if guaner_student??>
                ...
                <#if guaner_student.headPic??>
                    <img  class="avatar"  style="height:48px;width:48px;" src="/photo/view?filename=${guaner_student.headPic}">
                <#else>
                    <img class="avatar" style="height:48px;width:48px;" src="/home/imgs/avatar1.png">
                </#if>
                </a>
                <div style="display:inline;" class="person_name">
                <a href="../student/index" id="id-btn">Hi：${guaner_student.nickname!guaner_student.sn}</a>
                </div>
                <div style="display:inline;" class="person_name">
            ...
            <#else>
                <!-- loginandrigist -->
                <div class="button"><a href="../index/login" style="color: white">登录 / 注册</a></div>
            </#if>
        </div>
    </div>
</header>
